...
var taskInput = document.querySelector(".main__task_new");//Add a new task.
...
var createNewTaskElement = function (taskString) {
  ...
  label.classList.add("main__task_poz");
  ...
  editInput.classList.add("main__task_input")
...
var editTask = function () {
  ...
  var editInput = listItem.querySelector(".main__task_input");
